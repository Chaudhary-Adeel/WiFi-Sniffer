...
namespace WifiSniffer.Visualization
{
    internal static class TreeViewVisualizer
    {
        ...
        {
            TreeNode frameNode = treeView.Nodes.Add("WifiSniffer-Frame", String.Empty);
        ...
        {
            TreeNode ethernetNode = treeView.Nodes.Add("WifiSniffer-Ethernet", String.Empty);
        ...
        {
            TreeNode arpNode = treeView.Nodes.Add("WifiSniffer-ARP", String.Empty);
